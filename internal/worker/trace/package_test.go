...
//go:generate go tool mockgen -typed -package trace -destination clock_mock_test.go github.com/juju/clock Clock,Timer
//go:generate go tool mockgen -typed -package trace -destination agent_mock_test.go github.com/juju/juju/agent Agent,Config
//go:generate go tool mockgen -typed -package trace -destination tracer_mock_test.go github.com/juju/juju/internal/worker/trace TrackedTracer,Client,ClientTracer,ClientTracerProvider
//go:generate go tool mockgen -typed -package trace -destination trace_mock_test.go go.opentelemetry.io/otel/trace Span
