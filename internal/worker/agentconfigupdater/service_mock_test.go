...
// Source: github.com/juju/juju/internal/worker/agentconfigupdater (interfaces: ControllerDomainServices,ControllerNodeService,ControllerConfigService)
//
// Generated by this command:
//
//	mockgen -typed -package agentconfigupdater_test -destination service_mock_test.go github.com/juju/juju/internal/worker/agentconfigupdater ControllerDomainServices,ControllerNodeService,ControllerConfigService
//
...
func (m *MockControllerDomainServices) ControllerNode() agentconfigupdater.ControllerNodeService {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ControllerNode")
	ret0, _ := ret[0].(agentconfigupdater.ControllerNodeService)
	return ret0
}
...
// Return rewrite *gomock.Call.Return
func (c *MockControllerDomainServicesControllerNodeCall) Return(arg0 agentconfigupdater.ControllerNodeService) *MockControllerDomainServicesControllerNodeCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockControllerDomainServicesControllerNodeCall) Do(f func() agentconfigupdater.ControllerNodeService) *MockControllerDomainServicesControllerNodeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockControllerDomainServicesControllerNodeCall) DoAndReturn(f func() agentconfigupdater.ControllerNodeService) *MockControllerDomainServicesControllerNodeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// MockControllerNodeServiceIsControllerNodeCall wrap *gomock.Call
type MockControllerNodeServiceIsControllerNodeCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockControllerNodeServiceIsControllerNodeCall) Return(arg0 bool, arg1 error) *MockControllerNodeServiceIsControllerNodeCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockControllerNodeServiceIsControllerNodeCall) Do(f func(context.Context, string) (bool, error)) *MockControllerNodeServiceIsControllerNodeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockControllerNodeServiceIsControllerNodeCall) DoAndReturn(f func(context.Context, string) (bool, error)) *MockControllerNodeServiceIsControllerNodeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
