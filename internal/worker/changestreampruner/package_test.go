...
//go:generate go tool mockgen -typed -package changestreampruner -destination stream_mock_test.go github.com/juju/juju/internal/worker/changestreampruner DBGetter
//go:generate go tool mockgen -typed -package changestreampruner -destination clock_mock_test.go github.com/juju/clock Clock,Timer
//go:generate go tool mockgen -typed -package changestreampruner -destination worker_mock_test.go github.com/juju/worker/v4 Worker
