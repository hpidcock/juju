...
func (mr *MockManagerMockRecorder) CreateContainer(ctx, instanceConfig, cons, arg3, network, storage, callback any) *MockManagerCreateContainerCall {
	...
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateContainer", reflect.TypeOf((*MockManager)(nil).CreateContainer), ctx, instanceConfig, cons, arg3, network, storage, callback)
