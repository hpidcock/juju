...
func (m *MockTestLXDManager) AssignLXDProfiles(instID string, profilesNames []string, profilePosts []lxdprofile.ProfilePost) ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTestLXDManagerMockRecorder) AssignLXDProfiles(instID, profilesNames, profilePosts any) *MockTestLXDManagerAssignLXDProfilesCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AssignLXDProfiles", reflect.TypeOf((*MockTestLXDManager)(nil).AssignLXDProfiles), instID, profilesNames, profilePosts)
...
func (m *MockTestLXDManager) CreateContainer(ctx context.Context, instanceConfig *instancecfg.InstanceConfig, cons constraints.Value, arg3 base.Base, network *container.NetworkConfig, storage *container.StorageConfig, callback environs.StatusCallbackFunc) (instances.Instance, *instance.HardwareCharacteristics, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateContainer", ctx, instanceConfig, cons, arg3, network, storage, callback)
...
func (mr *MockTestLXDManagerMockRecorder) CreateContainer(ctx, instanceConfig, cons, arg3, network, storage, callback any) *MockTestLXDManagerCreateContainerCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateContainer", reflect.TypeOf((*MockTestLXDManager)(nil).CreateContainer), ctx, instanceConfig, cons, arg3, network, storage, callback)
...
func (m *MockTestLXDManager) MaybeWriteLXDProfile(pName string, put lxdprofile.Profile) error {
	m.ctrl.T.Helper()
...
func (mr *MockTestLXDManagerMockRecorder) MaybeWriteLXDProfile(pName, put any) *MockTestLXDManagerMaybeWriteLXDProfileCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MaybeWriteLXDProfile", reflect.TypeOf((*MockTestLXDManager)(nil).MaybeWriteLXDProfile), pName, put)
