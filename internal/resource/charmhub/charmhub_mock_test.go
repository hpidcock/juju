...
//
//	mockgen -typed -package charmhub_test -destination charmhub_mock_test.go github.com/juju/juju/internal/resource/charmhub ResourceClient,CharmHub,Downloader
//
...
// Do rewrite *gomock.Call.Do
func (c *MockDownloaderDownloadCall) Do(f func(context.Context, *url.URL, string, int64) (io.ReadCloser, error)) *MockDownloaderDownloadCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockDownloaderDownloadCall) DoAndReturn(f func(context.Context, *url.URL, string, int64) (io.ReadCloser, error)) *MockDownloaderDownloadCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
