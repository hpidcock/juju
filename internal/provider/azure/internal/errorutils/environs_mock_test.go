...
//
//	mockgen -typed -package errorutils_test -destination environs_mock_test.go github.com/juju/juju/environs CredentialInvalidator
//

// Package errorutils_test is a generated GoMock package.
