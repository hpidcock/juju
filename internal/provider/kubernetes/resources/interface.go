...
//go:generate go tool mockgen -typed -package mocks -destination mocks/resources_mock.go github.com/juju/juju/internal/provider/kubernetes/resources Resource,Applier
