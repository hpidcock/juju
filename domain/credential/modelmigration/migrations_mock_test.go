...
//
//	mockgen -typed -package modelmigration -destination migrations_mock_test.go github.com/juju/juju/domain/credential/modelmigration Coordinator,ImportService,ExportService
//
...
// MockExportServiceCloudCredentialCall wrap *gomock.Call
type MockExportServiceCloudCredentialCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockExportServiceCloudCredentialCall) Return(arg0 cloud.Credential, arg1 error) *MockExportServiceCloudCredentialCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockExportServiceCloudCredentialCall) Do(f func(context.Context, credential.Key) (cloud.Credential, error)) *MockExportServiceCloudCredentialCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockExportServiceCloudCredentialCall) DoAndReturn(f func(context.Context, credential.Key) (cloud.Credential, error)) *MockExportServiceCloudCredentialCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
