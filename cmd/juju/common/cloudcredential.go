...
//go:generate go tool mockgen -typed -package common -destination credentialstore_mock_test.go github.com/juju/juju/jujuclient CredentialStore
...
//go:generate go tool mockgen -typed -package common -destination cloudprovider_mock_test.go github.com/juju/juju/cmd/juju/common TestCloudProvider
