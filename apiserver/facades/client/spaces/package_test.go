...
//go:generate go tool mockgen -typed -package spaces -destination package_mock_test.go github.com/juju/juju/apiserver/facades/client/spaces Backing,BlockChecker,Machine,Constraints,Address,NetworkService,ControllerConfigService,ApplicationService
